<template>
	...
	<!-- <element-select class="xui-select xui-select-style" @visible-change="blur" :style="safeOptions.style" v-model="widgetValue" :placeholder="cplaceholder" :clearable="cclearable" :multiple="cmultiple" :disabled="cdisabled" :filterable="filterable" :filter-method="filterMethod" :size="csize">
